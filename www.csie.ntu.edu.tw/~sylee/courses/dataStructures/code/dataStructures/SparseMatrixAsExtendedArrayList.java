...
/** sparse matrix represented as a ExtendedArrayList */
...
public class SparseMatrixAsExtendedArrayList
{
   ...
   ExtendedArrayList terms;   // list of nonzero terms

   // constructors
   public SparseMatrixAsExtendedArrayList(int theRows, int theColumns,
                               int estimatedMaxSize, Object theZero)
   {
      ...
      cols = theColumns;
      zero = theZero;
      terms = new ExtendedArrayList(estimatedMaxSize);
   }
   ...
   public SparseMatrixAsExtendedArrayList(Object theZero)
      {this(1, 1, 1, theZero);}
   ...
   public String toString()
   {
      ...
      // use an ExtendedArrayList iterator
   ...
   public static SparseMatrixAsExtendedArrayList input(Object theZero,
                                            MyInputStream stream)
   {
      ...
      try
      {
         ...
         SparseMatrixAsExtendedArrayList x =
               new SparseMatrixAsExtendedArrayList(theZero);
         ...
         x.terms = new ExtendedArrayList(size);
         ...
         for (int i = 0; i < size; i++)
         {
            ...
            x.terms.add(i, newTerm);
                    // put into the ExtendedArrayList
         }
         return x;
      }
      catch (Exception e)
   ...
   public SparseMatrixAsExtendedArrayList transpose()
   {
      ...
      SparseMatrixAsExtendedArrayList t =
            new SparseMatrixAsExtendedArrayList(cols,
                                    rows, size, zero);
   ...
   /** @return this + m */
   public SparseMatrixAsExtendedArrayList
          add(SparseMatrixAsExtendedArrayList m)
   {
      ...
      // create result matrix
      SparseMatrixAsExtendedArrayList w =
            new SparseMatrixAsExtendedArrayList
                                    (rows, cols, zero);
   ...
   public static void main(String [] args)
   {
      ...
      SparseMatrixAsExtendedArrayList a, b;

      // define a MyInputStream object to input from System.in
      MyInputStream keyboard = new MyInputStream();

      // test input and output
      a = SparseMatrixAsExtendedArrayList.input(myZero, keyboard);
      System.out.println("The matrix a is");
      System.out.println(a);
      System.out.println();
      b = SparseMatrixAsExtendedArrayList.input(myZero, keyboard);
