...
/** time FastArrayLinearList operations */
...
public class TimeFastArrayLinearList
{
   public static void main(String [] args)
   {
      FastArrayLinearList s = new FastArrayLinearList();
      Integer x = new Integer(2);

      System.out.println("Timing FastArrayLinearList");
