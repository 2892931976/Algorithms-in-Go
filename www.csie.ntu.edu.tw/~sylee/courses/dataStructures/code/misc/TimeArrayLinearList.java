...
/** time ArrayLinearList operations */
...
public class TimeArrayLinearList
{
   public static void main(String [] args)
   {
      ArrayLinearList s = new ArrayLinearList();
      Integer x = new Integer(2);

      System.out.println("Timing ArrayLinearList");
