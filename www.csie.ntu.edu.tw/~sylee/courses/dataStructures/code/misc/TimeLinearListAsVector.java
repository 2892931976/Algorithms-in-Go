...
/** time LinearListAsVector operations */
...
public class TimeLinearListAsVector
{
   public static void main(String [] args)
   {
      LinearListAsVector s = new LinearListAsVector();
      Integer x = new Integer(2);

      System.out.println("Timing LinearListAsVector");
