...
/** second version of recursive dynamic programming image compression
  * avoids recomputation of s values */

package applications;

import utilities.*;

public class RecursiveDPImageCompression2
{
   ...
   static int [] s;        // s[i] is min space for first i segments
   
   /** set class data members and invoke method s */
   public static int vBits(int [] l, int [] b, int [] kay)
   {
      RecursiveDPImageCompression2.l = l;
      RecursiveDPImageCompression2.b = b;
      RecursiveDPImageCompression2.kay = kay;
      s = new int [l.length];
      return s(l.length - 1);
   }

   /** recursively compute s[i] = s(i) and kay[i] using the dynamic
     * programming recurrence, do not compute same s(i) twice */
