package com.example.msmk.imlib.netty;


import com.example.msmk.imlib.ExecutorServiceFactory;
import com.example.msmk.imlib.HeartbeatHandler;
import com.example.msmk.imlib.IMSConfig;
import com.example.msmk.imlib.MsgDispatcher;
import com.example.msmk.imlib.MsgTimeoutTimerManager;
import com.example.msmk.imlib.interf.IMSClientInterface;
import com.example.msmk.imlib.listener.IMSConnectStatusCallback;
import com.example.msmk.imlib.listener.OnEventListener;
import com.example.msmk.imlib.protobuf.MessageProtobuf;
...
public class NettyTcpClient implements IMSClientInterface {
    ...
    public void sendMsg(MessageProtobuf.Msg msg, boolean isJoinTimeoutManager) {
        ...
        System.out.println("222sendMsg start ......: "+msg);
        System.out.println("333sendMsg start ......: "+msg.getHead());
        System.out.println("444sendMsg start ......: "+msg.getHead().getMsgId());
    ...
    private void toServer() {
        try {
            System.err.println(String.format("789789连接Server(ip[%s], port[%s])失败", currentHost, currentPort));
    ...
    private class ResetConnectRunnable implements Runnable {
        ...
        private int reConnect() {
            ...
            if (!isClosed) {
                ...
                // 初始化bootstrap
                initBootstrap();
                System.err.println("4444789789initBootstrap");
        ...
        private int connectServer() {
            System.err.println("999789789connectServer");
