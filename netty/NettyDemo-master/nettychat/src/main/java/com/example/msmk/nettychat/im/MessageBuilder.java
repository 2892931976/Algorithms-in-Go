package com.example.msmk.nettychat.im;

import com.example.msmk.nettychat.bean.AppMessage;
import com.example.msmk.nettychat.bean.BaseMessage;
import com.example.msmk.nettychat.bean.ContentMessage;
import com.example.msmk.nettychat.bean.Head;
import com.example.msmk.nettychat.utils.StringUtil;
...
public class MessageBuilder {
    ...
    public static MessageProtobuf.Msg.Builder getProtoBufMessageBuilderByAppMessage(AppMessage message) {
        System.out.println("6666sendMsg ...... : "+message);
