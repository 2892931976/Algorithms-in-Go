...
import com.example.msmk.nettychat.im.handler.IMessageHandler;
import com.example.msmk.nettychat.im.handler.MessageHandlerFactory;
    ...
    public void sendMsg(final AppMessage message) {
        CThreadPoolExecutor.runInBackground(new Runnable() {
            ...
            public void run() {
                ...
                if (isActive) {
                    System.out.println("5555sendMsg ...... : "+message);
