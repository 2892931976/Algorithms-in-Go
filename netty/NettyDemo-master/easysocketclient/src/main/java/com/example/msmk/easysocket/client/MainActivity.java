...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SERVERIP = "192.168.1.132";
...
//        SocketAddress ss = new SocketAddress(SERVERIP, PORT);
//        socketActionListener.onSocketDisconnect(ss,true);
        //监听socket行为
    ...
    private void sendCallbackMsg() {
        ...
        sender.setFrom("I am lai android");
...
//                        LogUtil.d("回调消息=" + response.toString());
                        LogUtil.d("back data=" + response.toString());
                    }
...
//            sendCallbackMsg();
    ...
    private void initEasySocket() {
        ...
        EasySocketOptions options = new EasySocketOptions.Builder()
                .setSocketAddress(new SocketAddress(SERVERIP, PORT)) //主机地址
