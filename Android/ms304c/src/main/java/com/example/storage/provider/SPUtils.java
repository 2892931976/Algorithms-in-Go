...
public class SPUtils {
     ...
     * 保存在手机里的SP文件名
     */
    public static final String FILE_NAME = "my_sp2";
...
//    }
    ...
    public static void putInt(SharedPreferences sp, String key, int obj) {
//        SharedPreferences sp = context.getSharedPreferences(FILE_NAME, context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//    }
    ...
    public static int getInt(SharedPreferences sp, String key, int defaultObj) {
//        SharedPreferences sp = context.getSharedPreferences(FILE_NAME, context.MODE_PRIVATE);
