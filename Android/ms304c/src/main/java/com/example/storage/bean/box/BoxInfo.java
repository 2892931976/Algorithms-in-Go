...
public class BoxInfo {
    ...
    public static void setDescArray(String[] descArray) {
        BoxInfo.descArray = descArray;
    }

    public BoxInfo(String boxName, String tag) {
        this.boxName = boxName;
        this.tag = tag;
    }

    public BoxInfo(int boxId, String created, int createdBy, int sysBoxId, String tag,
    ...
    public static ArrayList<BoxInfo> getDefaultList() {
        ArrayList<BoxInfo> planetList = new ArrayList<BoxInfo>();
        for (int i = 0; i < iconArray.length; i++) {
            planetList.add(new BoxInfo(nameArray[i], descArray[i]));
        }
        return planetList;
    }
}
